...
; Get the installer path from the command-line arguments
Local $installerPath = $CmdLine[1]
If $installerPath = "" Then
    MsgBox(0, "Error", "No installer path provided. Please pass the path of the installer as an argument.")
    Exit
EndIf
